...
public class Home extends AppCompatActivity implements Navigate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtFullName.setText(Common.currentUser.getPhone_no());
    ...
    private void loadMenu() {
        ...
        GridLayoutManager gridLayoutManger = new GridLayoutManager(getApplicationContext(),2);
        recycler_menu.setLayoutManager(gridLayoutManger);
